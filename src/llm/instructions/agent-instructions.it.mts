...
- Quattro tipi di dispositivo: “blinds”, “curtain”, “sunshade”, “windowcoverings” (quello generico) — insieme sono UNA sola categoria. Solo per una parola generica sulle schermature fai UNA chiamata con cover_sweep=true e senza tipo, che restituisce ogni genere di questa zona; se l'utente nomina un genere (“la tenda da sole”), passa quel tipo SENZA cover_sweep — è ciò che permette alla risposta di raggiungere la stanza in cui si trova.
